        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-pattern" style="box-shadow: 0px 0px 15px #cacaca;border-radius:10px">

                        <div class="card-body p-4">

                            <div class="text-center w-75 m-auto">
                                <a href="index.php">
                                    <span><img src="assets/images/mediverse.png" alt="" class="w-50"></span>
                                </a>
                                <p class="text-muted mb-2">Enter your email address and password to access admin panel.</p>
                            </div>
